...
NS_LOG_COMPONENT_DEFINE ("labfinalq2");
...
main (int argc, char *argv[])
{
  ...
  saida.open("/home/ns3/ns-allinone-3.33/ns-3.33/labfinalq2.csv");
  ...
  bottleneckLink.EnableAsciiAll(ascii.CreateFileStream("labfinalq2.tr"));

  // Habilita rastreamento de trafego em formato PCAP
  bottleneckLink.EnablePcap ("labfinalq2", devicesBottleneckLink.Get(0));
  ...
  flowMonitor->SerializeToXmlFile("labfinalq2.xml", true, true);
  ...
  Create2DPlotFile (dataset1, "labfinalq2", "Tamanho da Fila x Tempo de Simulacao", "Pacotes na fila", "Tempo de Simulacao (s)",
