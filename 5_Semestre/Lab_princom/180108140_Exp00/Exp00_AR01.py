...
class Exp00_AR01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Exp00_AR01")
        ...
        labels = ['Senóide', 'Onda quadrada', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SQR_WAVE, 1000, 1, 0, 0)
...
def main(top_block_cls=Exp00_AR01, options=None):
