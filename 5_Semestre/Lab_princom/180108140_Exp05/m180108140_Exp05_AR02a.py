...
class m180108140_Exp05_AR02a(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AR02a")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AR02a")
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp05_AR02a")
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 500, 10, -5, 0)
        ...
        self.connect((self.blocks_float_to_complex_0, 0), (self.qtgui_freq_sink_x_0, 1))
...
def main(top_block_cls=m180108140_Exp05_AR02a, options=None):
