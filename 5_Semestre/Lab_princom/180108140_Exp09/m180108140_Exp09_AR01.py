...
class m180108140_Exp09_AR01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp09_AR01")
        ...
        # Variables
        ##################################################
        self.packet_len = packet_len = 22
        self.samp_rate = samp_rate = 256000
        self.len_tag_key = len_tag_key = packet_len
        self.fft_len = fft_len = 256
        self.CP_len = CP_len = 1
        ...
        labels = ['qam_FASE', 'qam_QUADRATURA', 'ofdm_real', 'ofdm_img', 'Signal 5',
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 62500, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 62500, 1, 0, 0)
        ...
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_complex_to_imag_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.blocks_complex_to_real_0, 0))
        self.connect((self.digital_ofdm_tx_0, 0), (self.qtgui_freq_sink_x_0, 1))
        self.connect((self.digital_ofdm_tx_0, 0), (self.qtgui_time_sink_x_0, 1))
...
def main(top_block_cls=m180108140_Exp09_AR01, options=None):
