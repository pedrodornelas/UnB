...
class m180108140_Exp01_AR03(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "AR03")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("AR03")
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp01_AR03")
        ...
        labels = ['', 'A', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.top_grid_layout.addWidget(self._qtgui_number_sink_0_0_win, 3, 1, 1, 4)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_0_win, 1, 3, 2, 2)
        for r in range(1, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.band_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.band_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 100, 2, -1, 0)
        self.analog_sig_source_x_1_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 16000, 4, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000, 2, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 6000, 5, 0, 0)
        ...
        self.connect((self.analog_sig_source_x_1, 0), (self.blocks_throttle_0_0_0, 0))
        self.connect((self.analog_sig_source_x_1_0, 0), (self.blocks_throttle_0_0_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0, 0), (self.blocks_rms_xx_0_0, 0))
        ...
        self.connect((self.blocks_multiply_xx_0_0_0_0, 0), (self.qtgui_number_sink_0_0, 0))
        self.connect((self.blocks_rms_xx_0_0, 0), (self.blocks_multiply_xx_0_0_0_0, 0))
        self.connect((self.blocks_rms_xx_0_0, 0), (self.blocks_multiply_xx_0_0_0_0, 1))
        ...
        self.connect((self.blocks_throttle_0_0_0_0, 0), (self.blocks_multiply_xx_0_0_0, 1))
...
def main(top_block_cls=m180108140_Exp01_AR03, options=None):
