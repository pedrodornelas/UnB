...
class m180108140_Exp02_AR02(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp02_AR02")
        ...
        # Blocks
        ##################################################
        self._samp_rate_range = Range(0, 248000, 1000, 128000, 200)
        ...
        self._fc_range = Range(0, 32000, 100, 10000, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 20, 2, -1, 0)
...
def main(top_block_cls=m180108140_Exp02_AR02, options=None):
