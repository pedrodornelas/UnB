...
class m180108140_Exp05_AR03(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp05_AR03")
        ...
        self.low_pass_filter_0 = filter.fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                firdes.WIN_HAMMING,
                6.76))
        self.fir_filter_xxx_0 = filter.fir_filter_ccc(1, [-0.1044, -0.2268, 0.7116, -0.2268, -0.1044])
        ...
        self.analog_sig_source_x_1 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, 30000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 500, 10, -5, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(80, self.samp_rate, 5000, 100, firdes.WIN_HAMMING, 6.76))
...
def main(top_block_cls=m180108140_Exp05_AR03, options=None):
