...
class m180108140_Exp02_AR01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp02_AR01")
        ...
        # Blocks
        ##################################################
        self._Ka_range = Range(0, 12, 1, 6, 200)
        self._Ka_win = RangeWidget(self._Ka_range, self.set_Ka, 'Ka', "counter_slider", float)
        self.top_grid_layout.addWidget(self._Ka_win, 7, 1, 1, 4)
        for r in range(7, 8):
        ...
        labels = ['z(t)=Ac+Ka m(t)', 's(t)', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.top_grid_layout.addWidget(self._qtgui_const_sink_x_0_win, 1, 3, 6, 2)
        for r in range(1, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 33000, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, 1100, 2, -1, 0)
...
def main(top_block_cls=m180108140_Exp02_AR01, options=None):
