...
std::ofstream meuarquivo("tcpcwnd_NewReno", std::fstream::app); // Arquivo que guardará informação tempo simulação e tamanho janela 
...

{
 ...
 devices.Get (1)->TraceConnectWithoutContext ("PhyRxDrop", MakeCallback (&RxDrop));
  ...
  Create2DPlotFile(dataset, "tcpcwnd_NewReno", "Gráfico de Mudança CWND", "Tamanho CWND", "Tempo Simulação", "Tamanho CWND (bytes)",
  "[2:4]", "[0:8000]");
