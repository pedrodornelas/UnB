...
class m180108140_Exp04_AR01(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp04_AR01")
        ...
        # Blocks
        ##################################################
        self._fm_range = Range(0, 1, 0.01, 0.05, 200)
        self._fm_win = RangeWidget(self._fm_range, self.set_fm, 'fm', "counter_slider", float)
        self.top_grid_layout.addWidget(self._fm_win, 7, 3, 1, 1)
        for r in range(7, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 4):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._fc_range = Range(8000, 12000, 100, 10000, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, 'fc', "counter_slider", float)
        self.top_grid_layout.addWidget(self._fc_win, 7, 4, 1, 1)
        for r in range(7, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(4, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._Am_win, 7, 1, 1, 1)
        for r in range(7, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        labels = ['Re{VCO}', 'Im{VCO}', 'Re{PLL}', 'Im{PLL}', 'Signal 5',
        ...
        self.top_grid_layout.addWidget(self._qtgui_time_sink_x_0_win, 1, 1, 6, 2)
        for r in range(1, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_win, 1, 3, 6, 2)
        for r in range(1, 7):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(3, 5):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._fΔ_range = Range(500, 2000, 100, 500, 200)
        self._fΔ_win = RangeWidget(self._fΔ_range, self.set_fΔ, 'fΔ', "counter_slider", float)
        self.top_grid_layout.addWidget(self._fΔ_win, 7, 2, 1, 1)
        for r in range(7, 8):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(2, 3):
            self.top_grid_layout.setColumnStretch(c, 1)
        self.blocks_vco_c_0 = blocks.vco_c(samp_rate, 2000*pi, 1)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, fm, 2*Am, -Am, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.analog_pll_refout_cc_0, 0))
    ...
    def set_Am(self, Am):
        ...
        self.analog_sig_source_x_0.set_offset(-self.Am)



def main(top_block_cls=m180108140_Exp04_AR01, options=None):
