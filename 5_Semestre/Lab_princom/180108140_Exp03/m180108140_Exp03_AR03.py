...
class m180108140_Exp03_AR03(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "m180108140_Exp03_AR03")
        ...
        labels = ['Demodulado', 'Mensagem', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.analog_sig_source_x_3_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 10000.1, Arx, 0, 0)
...
def main(top_block_cls=m180108140_Exp03_AR03, options=None):
